...
public class ExtentReportUtils {
    ...
    public static void setUpExtentReport(String reportName) {
        if (extentReports == null) { // ExtentReports nesnesi oluşturulmamış ise
            ...
            String path = "target" + File.separator + "extentReport/" + reportName + " " + date + " htmlReport.html";
            ...
            extentReports.setSystemInfo("Test Automation Engineer", "TeamQA DE");
        }
    }
    ...
    public static void addScreenShotToReport() {
        String date = DateTimeFormatter.ofPattern("ddMMyyyy_HHmmss").format(LocalDateTime.now());
        String path = "src" + File.separator + "test" + File.separator + "java" + File.separator  + "allovercommerceTestNG" + File.separator  +"testOutputs" + File.separator  + "screenShots" + date + ".png";
        TakesScreenshot ts = (TakesScreenshot) Driver.getDriver();
        try {
            Files.write(Paths.get(path), ts.getScreenshotAs(OutputType.BYTES));
            extentTest.addScreenCaptureFromPath(System.getProperty("user.dir") + File.separator + path);
        } catch (IOException e) {
    ...
    public static void addScreenShotOfWebElementToReport(WebElement webElement) {
        String date = DateTimeFormatter.ofPattern("ddMMyyyy_HHmmss").format(LocalDateTime.now());
        //String path = "src\\test\\java\\allovercommerceTestNG\\testOutputs\\webElementScreenshots" + date + ".png";
        String path = "src" + File.separator + "test" + File.separator + "java" +
                File.separator + "allovercommerceTestNG" + File.separator +
                "testOutputs" + File.separator + "webElementScreenshots" + date + ".png";
        try {
